...
- At the AtlasV4/0.4.0 guest bump: move to the 0.4.0-line hook (upstream
  PR; see Setup), account for the line's semantic drift (blake2s-merkle
  header tx/receipt roots, Pectra fee/precompile semantics), and re-visit
  the blake2f/KZG/bls stub coverage question.
