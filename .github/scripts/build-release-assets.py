#!/usr/bin/env python3
"""Build the release manifest and its checksum file."""
...
def main() -> None:
    ...
    inner_elf = copy_asset(args.inner_elf, args.output / "zksync-os-zisk-guest")
    aggregator_elf = copy_asset(
        args.aggregator_elf, args.output / "zksync-os-zisk-guest-aggregator"
    )
    ...
    manifest = {
        ...
        "era_verification_key_hash": era_hash,
        "era_verification_key_hash_preimage": [
